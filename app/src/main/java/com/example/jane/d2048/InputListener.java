...
import com.example.jane.d2048.MainActivity;
...
//						mView.game.cheat();
//					} else if (iconPressed(mView.sXQQ, mView.sYIcons)){
//						MainActivity.instance.shareqq();
//					} else if (iconPressed(mView.sXWX, mView.sYIcons)){
//						MainActivity.instance.sharewx();
					}else if (iconPressed(mView.sXSR, mView.sYIcons)){
						MainActivity.instance.sharesr();
					}
					else if (isTap(2)
