...
import com.example.jane.d2048.R;
...
//    private void drawQQButton(Canvas canvas) {
//        drawDrawable(canvas, backgroundRectangle, sXQQ, sYIcons,
//                sXQQ + iconSize, sYIcons + iconSize);
//        drawDrawable(canvas, qqIcon, sXQQ + iconPaddingSize, sYIcons
//                + iconPaddingSize, sXQQ + iconSize - iconPaddingSize, sYIcons
//                + iconSize - iconPaddingSize);
//    }

    private void drawSRButton(Canvas canvas) {
        drawDrawable(canvas, backgroundRectangle, sXSR, sYIcons,
                sXSR + iconSize, sYIcons + iconSize);
        drawDrawable(canvas, srIcon, sXSR + iconPaddingSize, sYIcons
                + iconPaddingSize, sXSR + iconSize - iconPaddingSize, sYIcons
                + iconSize - iconPaddingSize);
    }
//    public void drawWXButton(Canvas canvas) {
//        drawDrawable(canvas, backgroundRectangle, sXWX, sYIcons,
//                sXWX + iconSize, sYIcons + iconSize);
//        drawDrawable(canvas, wxIcon, sXWX + iconPaddingSize, sYIcons
//                + iconPaddingSize, sXWX + iconSize - iconPaddingSize, sYIcons
//                + iconSize - iconPaddingSize);
//    }
...
//        sXWX = sXCheat - iconSize * 3 / 2 - iconPaddingSize;
//        sXQQ = sXWX - iconSize * 3 / 2 - iconPaddingSize;
        sXSR = sXUndo - iconSize * 3 / 2 - iconPaddingSize;
...
//            qqIcon = resources.getDrawable(R.drawable.ic_action_qq);
//            wxIcon = resources.getDrawable(R.drawable.ic_action_wechat);
            srIcon = resources.getDrawable(R.drawable.ic_action_sr);
