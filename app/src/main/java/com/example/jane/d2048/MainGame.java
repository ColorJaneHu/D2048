...
import com.example.jane.d2048.MainView;
import com.example.jane.d2048.InputListener;
public class MainGame {
    ...
    public static MainGame ins = null;
...
//        playSound(3, 1);
        if (grid == null) {
            grid = new Grid(numSquaresX, numSquaresY);//�״ν�����Ϸ��Ҫ��ʼ��
        } else {
            prepareUndoState();//����׼��
            saveUndoState();//�洢��һ��״̬
            grid.clearGrid();//����
